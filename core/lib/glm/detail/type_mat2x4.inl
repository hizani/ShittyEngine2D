namespace glm
{
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 4, T, Q>::mat()
		...
		: value
	{
		col_type(1, 0, 0, 0), col_type(0, 1, 0, 0)
	}
#endif
	{
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 4, T, Q>::mat(T s)
		...
		: value
	{
		col_type(s, 0, 0, 0), col_type(0, s, 0, 0)
	}
#endif
	{
#if !GLM_HAS_INITIALIZER_LISTS
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 4, T, Q>::mat(
		...
		: value
	{
		col_type(x0, y0, z0, w0), col_type(x1, y1, z1, w1)
	}
#endif
	{
#if !GLM_HAS_INITIALIZER_LISTS
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 4, T, Q>::mat(mat<2, 2, T, Q> const &m)
		...
		: value
	{
		col_type(m[0], 0, 0), col_type(m[1], 0, 0)
	}
#endif
	{
#if !GLM_HAS_INITIALIZER_LISTS
