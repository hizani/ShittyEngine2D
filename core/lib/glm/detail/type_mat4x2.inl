namespace glm
{
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 2, T, Q>::mat()
		...
		: value
	{
		col_type(1, 0), col_type(0, 1), col_type(0, 0), col_type(0, 0)
	}
#endif
	{
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 2, T, Q>::mat(T s)
		...
		: value
	{
		col_type(s, 0), col_type(0, s), col_type(0, 0), col_type(0, 0)
	}
#endif
	{
#if !GLM_HAS_INITIALIZER_LISTS
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 2, T, Q>::mat(
		...
		: value
	{
		col_type(x0, y0), col_type(x1, y1), col_type(x2, y2), col_type(x3, y3)
	}
#endif
	{
#if !GLM_HAS_INITIALIZER_LISTS
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 2, T, Q>::mat(mat<2, 2, T, Q> const &m)
		...
		: value
	{
		col_type(m[0]), col_type(m[1]), col_type(0), col_type(0)
	}
#endif
	{
#if !GLM_HAS_INITIALIZER_LISTS
