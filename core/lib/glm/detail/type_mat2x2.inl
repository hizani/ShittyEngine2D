...
namespace glm
{
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 2, T, Q>::mat(T scalar)
		...
		: value
	{
		col_type(scalar, 0), col_type(0, scalar)
	}
#endif
	{
#if !GLM_HAS_INITIALIZER_LISTS
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 2, T, Q>::mat(
		...
		: value
	{
		col_type(static_cast<T>(x1), value_type(y1)), col_type(static_cast<T>(x2), value_type(y2))
	}
#endif
	{
#if !GLM_HAS_INITIALIZER_LISTS
